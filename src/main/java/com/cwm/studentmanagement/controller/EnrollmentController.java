...
public class EnrollmentController {
	...
	public String enrollmentList(@RequestParam(defaultValue = "0")int page,
		...
		Log.info("Get /enrollmentList - showing enrolled student list student page");
	...
	public String enrollCourse(@Valid @ModelAttribute("enrollmentDto") EnrollmentDTO enrollmentDTO,
	   ...
	   redirectAttributes.addAttribute("message", "Enrollment sucessfully!!");
		
		Log.info("Post /enrollments/enrollCourse - Enrollment sucessfully.");
